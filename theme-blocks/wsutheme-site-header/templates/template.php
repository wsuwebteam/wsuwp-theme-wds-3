	...
	<div class="wsu-header-unit__inner">
		<div class="wsu-header-unit__banner">
			<div class="wsu-logo-lockup  wsu-logo-lockup--style-unit">
				...
				<?php if ( ! empty( $args['subtitleLink'] ) ) : ?>
				<span class="wsu-logo-lockup__title-wrapper">
					<a class="wsu-logo-lockup__subtitle" href="<?php echo esc_url( $args['subtitleLink'] ); ?>"><?php echo wp_kses_post( $args['siteSubtitle'] ); ?></a>
					<a class="wsu-logo-lockup__title" href="<?php echo esc_url( $args['siteLink'] ); ?>"><?php echo wp_kses_post( $args['siteTitle'] ); ?></a>
				</span>
				<?php else : ?>
				<a class="wsu-logo-lockup__title-wrapper" href="<?php echo esc_url( $args['siteLink'] ); ?>">
