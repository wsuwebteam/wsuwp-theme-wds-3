...
class Block_Article_Banner extends Theme_Block {

	protected static $block_slug    = 'article-banner';
	protected static $option_group  = 'article_banner';
