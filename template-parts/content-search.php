<?php get_template_part( 'template-parts/layout-start', 'search', array( 'template' => 'search' ) ); ?>
...
<?php get_template_part( 'template-parts/layout-end', 'search', array( 'template' => 'search' ) ); ?>